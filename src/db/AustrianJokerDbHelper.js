...
AustrianJokerDbHelper.prototype.readLotteryNumbers = (echoUserId) => {
...
AustrianJokerDbHelper.prototype.updateLotteryNumbers = (echoUserId, lottoNumbersValue) => {
  for(var i = 0; i < lottoNumbersValue.length; i++)
    ...
    return new Promise((resolve, reject) => {
      var params = {
        ...
        UpdateExpression: 'set austrianJoker = :t',
        ExpressionAttributeValues: {
          ':t' : lottoNumbersValue
        }
      };
