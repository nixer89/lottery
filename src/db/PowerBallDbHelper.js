...
PowerBallDbHelper.prototype.readLotteryNumbers = (echoUserId) => {
  return new Promise((resolve, reject) => {
    ...
    dynamoDb.query(params, (err, data) => {
        ...
        if(data.Items[0])
          resolve(data.Items[0].powerBall);
        else
          resolve(null);
    })
  });
...
PowerBallDbHelper.prototype.updateLotteryNumbers = (echoUserId, lottoNumbersValue) => {
  return new Promise((resolve, reject) => {
    var params = {
      TableName: LOTTO_DATA_TABLE_NAME,
      Key: {
      ...
      UpdateExpression: 'set powerBall = :t',
      ExpressionAttributeValues: {
        ':t' : lottoNumbersValue
      }
    };
