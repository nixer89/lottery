...
EuroMillionsDbHelper.prototype.readLotteryNumbers = (echoUserId) => {
...
EuroMillionsDbHelper.prototype.updateLotteryNumbers = (echoUserId, lottoNumbersValue) => {
  return new Promise((resolve, reject) => {
    var params = {
      TableName: LOTTO_DATA_TABLE_NAME,
      Key: {
      ...
      UpdateExpression: 'set euroMillions = :t',
      ExpressionAttributeValues: {
        ':t' : lottoNumbersValue
      }
    };
