...
MegaMillionsDbHelper.prototype.readLotteryNumbers = (echoUserId) => {
  return new Promise((resolve, reject) => {
    ...
    dynamoDb.query(params, (err, data) => {
        ...
        resolve(data.Items[0].megaMillions)
    })
  });
};

MegaMillionsDbHelper.prototype.updateLotteryNumbers = (echoUserId, lottoNumbersValue) => {
  return new Promise((resolve, reject) => {
    var params = {
      TableName: LOTTO_DATA_TABLE_NAME,
      Key: {
      ...
      UpdateExpression: 'set megaMillions = :t',
      ExpressionAttributeValues: {
        ':t' : lottoNumbersValue
      }
    };
