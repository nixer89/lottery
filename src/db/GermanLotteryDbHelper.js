...
GermanLotteryDbHelper.prototype.readLotteryNumbers = (echoUserId) => {
  return new Promise((resolve, reject) => {
    ...
    dynamoDb.query(params, (err, data) => {
        ...
        resolve(data.Items[0].german6aus49)
    })
  });
};

GermanLotteryDbHelper.prototype.updateLotteryNumbers = (echoUserId, lottoNumbersValue) => {
  return new Promise((resolve, reject) => {
    var params = {
      TableName: LOTTO_DATA_TABLE_NAME,
      Key: {
      ...
      UpdateExpression: 'set german6aus49 = :t',
      ExpressionAttributeValues: {
        ':t' : lottoNumbersValue
      }
    };
